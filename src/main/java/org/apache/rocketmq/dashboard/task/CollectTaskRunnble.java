            ...
            for (BrokerData bd : topicRouteData.getBrokerDatas()) {
                ...
                if (masterAddr != null) {
                    try {
                        ...
                        log.warn("mqAdminExt get broker stats data TOPIC_PUT_NUMS failed, topic [{}], errorMsg:{}", topic, e.getMessage());
                    }
                }
            }
                    ...
                    for (BrokerData bd : topicRouteData.getBrokerDatas()) {
                        ...
                        if (masterAddr != null) {
                            try {
                                ...
                                log.warn("mqAdminExt get broker stats data GROUP_GET_NUMS failed, topic [{}], group [{}], errorMsg:{}", topic, group, e.getMessage());
                            }
                        }
                    }
                }
